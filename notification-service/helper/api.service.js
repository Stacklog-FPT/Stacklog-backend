...
async function getLectureIdFromGroupss(groupId) {
  try {
    const response = await axios.get(`http://classservice:2003/group/findbyid?groupId=${groupId}`, {
      headers: {
        Authorization: `Bearer`
      }
    });
